...
**Canonical copy:** ``hqvmpy/src/pyhqiv/fluid.py`` (uses ``gamma_hqiv()`` from metric).
This ``bak`` tree may still import ``pyhqiv.constants``; prefer the src module for new work.
